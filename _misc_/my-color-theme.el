...
(custom-theme-set-faces
 ...
 '(modeline ((t (:foreground "#eeeeec" :background "#555753"))))
 ...
 '(lazy-highlight ((t (:background "dark olive green"))))
 '(link ((t (:foreground "deepskyblue" :underline t))))
 '(link-visited ((t (:foreground "indianred" :underline t))))
...
(custom-theme-set-faces
 ...
 '(modeline ((t (:foreground "#96dd3b" :background "#336442"))))
