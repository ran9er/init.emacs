...
;; Time-stamp:   <2012-09-10 23:31:51 ran9er>
...
(defun ih-make-head()
  (let* ((p (point))
         ...
         o)
    (or 
     ;; (setq o (find-if (lambda(x)(overlay-get x ih-head)) l))
